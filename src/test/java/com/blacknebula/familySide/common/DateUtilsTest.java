...
public class DateUtilsTest {
     ...
     * @see DateUtils#dateWithoutTime(java.util.Date)
     */
    @Test
    ...
    /**
     * @verifies throw an exception if date is null
     * @see DateUtils#addDays(java.util.Date, int)
     */
    @Test
    ...
    /**
     * @verifies throw an exception if date is null
     * @see DateUtils#addHours(java.util.Date, int)
     */
    @Test
    ...
    /**
     * @verifies throw an exception if date is null
     * @see DateUtils#addMinutes(java.util.Date, int)
     */
    @Test
    ...
    /**
     * @verifies throw an exception if date is null
     * @see DateUtils#addSeconds(java.util.Date, int)
     */
    @Test
